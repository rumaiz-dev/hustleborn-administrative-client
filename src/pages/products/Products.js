...
const Products = () => {
    ...
    }, [currentPage, productTypeFilter, productNameFilter, productSkuFilter, productCodeFilter, productStatuFilter, startDate, endDate]);
                ...
                <CCardBody>
                    <CRow className="mb-3">
                        <CCol xs={12} className="d-flex flex-wrap gap-2 align-items-end">
                            ...
                            <CCol>
                                <label htmlFor="product-type" className="form-label small mb-1">Product Type</label>
                                <CFormSelect
                                    size="sm"
                            ...
                            <CCol>
                                <label htmlFor="search-name" className="form-label small mb-1">Search by Name</label>
                                <CFormInput
                                    type="text"
                            ...
                            <CCol>
                                <label htmlFor="search-sku" className="form-label small mb-1">Search by SKU</label>
                                <CFormInput
                                    type="text"
                                    className="form-control form-control-sm"
                            ...
                            <CCol>
                                <label htmlFor="search-code" className="form-label small mb-1">Search by Code</label>
                                <CFormInput
                                    type="text"
                                    className="form-control form-control-sm"
                            ...
                            <CCol>
                                <label htmlFor="start-date" className="form-label small mb-1">Start Date (Created At)</label>
                                <CFormInput
                                    type="date"
                                    max={today}
                                    value={tempStartDate}
                            ...
                            <CCol>
                                <label htmlFor="end-date" className="form-label small mb-1">End Date (Created At)</label>
                                <CFormInput
                                    type="date"
                                    max={today}
                                    value={tempEndDate}
                    ...
                    <CRow className="mb-3">
                        <CCol xs={12} className="d-flex gap-2 align-items-end">
                            <CCol style={{ maxWidth: '160px' }}>
                                <label htmlFor="status-filter" className="form-label small mb-1">Status</label>
                                <CFormSelect
                                    size="sm"
                            ...
                            <CCol style={{ maxWidth: 'fit-content', paddingTop: '24px' }}>
                                <button type="submit" onClick={applyFilter} className="btn btn-sm btn-filter">
                                    Filter
                                </button>
                            </CCol>
                        </CCol>
                    ...
                    {loading ? (
                        ...
                        <>
                            <CTable striped hover responsive align="middle" className="text-start small">
